function [T2Map,FitMap,fitparams,T2Map_bi,FitMap_bi,fitparams_bi,fun,fun_bi,data] = T1T2_T2fitTE_biexpo(data,TEmat,TRmat,TheseVox,opts)
...
tic
for xv = 1:T2MapSize(1)*T2MapSize(2);
